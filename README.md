...
2. Get your prefered theme from the [releases page](https://github.com/catppuccin/sddm/releases).
3. Uzip the contenst of the release into `/usr/share/sddm/themes/`
